...
Simply said, _The Combat Action Executor_ gets a Root Assigned. It additionaly handles the playing of the [Montages](http://blueprintue.com/blueprint/wbj_7cj1/), Cooldown, etc., and [uses the _Node Navigator_ like a Cursor](https://blueprintue.com/blueprint/tq0lzvpy/).
